  ...
  const handleUpload = async (e) => {
    ...
    try {
      const res = await axios.post(
        "https://prabisvg.com/phpbox/adddonor.php",
        formData,
        {
          headers: {
  ...
  return (
    <AdminLayout>
      <div className="flex w-full items-center justify-center min-h-screen ">
        <div className="bg-white shadow-lg rounded-lg p-8 md:w-1/2 lg:w-1/2">
          <h2 className="text-2xl font-bold mb-6 text-center">Add Donor</h2>
          {message && (
